...
const artistQuestion = JSON.parse(`{"type":"artist","data":{"artistName":"Би-2","song":"Молитва","file":"sound/2.mp3","genre":"Rock"},"answers":[{"valid":true,"artistName":"Би-2","image":"./img/artists/bi-2.jpg"},{"valid":false,"artistName":"Краски","image":"./img/artists/kraski.jpg"},{"valid":false,"artistName":"Мельница","image":"./img/artists/melnica.jpg"}]}`);
const genreQuestion = JSON.parse(`{"type":"genre","data":{"genreName":"Rock","description":"Рок"},"answers":[{"valid":true,"song":"Би-2","file":"sound/1.mp3"},{"valid":true,"song":"Оранжевое солнце","file":"sound/2.mp3"},{"valid":false,"song":"Вселенная бесконечна","file":"sound/4.mp3"}]}`);
